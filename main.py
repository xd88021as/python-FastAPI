...
# @app.post(
#     "/v1/taiwanese-id-card/front/verify",
#     summary="取得身分證正面影像之辨識結果",
#     status_code=201,
#     response_model=TaskOut,
#     responses=get_example_201_responses_dict(
#         TaskOut.get_example()
#     ),
# )
# def post_taiwanese_id_card_front_verify(
#     imgPost: ImgPost,
#     mask_sensitive_info_bool: bool = Query(
#         False,
#         description="是否對回傳之敏感資料(姓名、身分證字號)進行部分遮蔽",
#     ),
# ):
#     return TaskOut.get_example()


# @app.get(
#     "/v1/taiwanese-id-card/front/verify",
#     summary="取得身分證正面影像之辨識結果",
#     response_model=id_card.VerifyOut,
#     responses=get_example_200_responses_dict(
#         id_card.VerifyOut.get_example()
#     ),
# )
# def get_taiwanese_id_card_front_verify(
#     task_id: str = Query(
#         ...,
#         description="任務 ID",
#     ),
# ):
#     return id_card.VerifyOut.get_example()


# @app.post(
#     "/v1/taiwanese-id-card/back/verify",
#     summary="取得身分證背面影像之辨識結果",
#     status_code=201,
#     response_model=TaskOut,
#     responses=get_example_201_responses_dict(
#         TaskOut.get_example()
#     ),
# )
# def post_taiwanese_id_card_back_verify(
#     imgPost: ImgPost,
# ):
#     return TaskOut.get_example()
...
#     "/v1/taiwanese-id-card/back/verify",
#     summary="取得身分證背面影像之辨識結果",
#     response_model=id_card_back.VerifyOut,
#     responses=get_example_200_responses_dict(
#         id_card_back.VerifyOut.get_example()
#     ),
# )
# def get_taiwanese_id_card_back_verify(
#     task_id: str = Query(
#         ...,
#         description="任務 ID",
#     ),
# ):
#     return id_card_back.VerifyOut.get_example()


# @app.post(
#     "/v1/nhi-card/front/verify",
#     summary="取得健保卡正面影像之辨識結果",
#     status_code=201,
#     response_model=TaskOut,
#     responses=get_example_201_responses_dict(
#         TaskOut.get_example()
#     ),
# )
# def post_taiwanese_health_card_verify(
#     imgPost: ImgPost,
#     mask_sensitive_info_bool: bool = Query(
#         False,
#         description="是否對回傳之敏感資料(姓名、身分證字號)進行部分遮蔽",
...
#     "/v1/nhi-card/front/verify",
#     summary="取得健保卡正面影像之辨識結果",
#     response_model=health_card.VerifyOut,
#     responses=get_example_201_responses_dict(
#         TaskOut.get_example()
#     ),
# )
# def get_taiwanese_health_card_verify(
#     task_id: str = Query(
#         ...,
#         description="任務 ID",
#     ),
# ):
#     return health_card.VerifyOut.get_example()
...
#     "/v1/ps-detect",
#     summary="取得P圖偵測之辨識結果",
#     response_model=ps_detect.Out,
#     responses=get_example_200_responses_dict(
#         ps_detect.Out.get_example()
#     ),
# )
# def get_ps_detect(
#     task_id: str = Query(
...
#     ),
# ):
#     return ps_detect.Out.get_example()


# @app.post(
#     "/v1/ps-detect-image",
#     summary="取得P圖偵測加工痕跡之影像",
#     status_code=201,
#     response_model=TaskOut,
#     responses=get_example_201_responses_dict(
#         TaskOut.get_example()
#     ),)
# def post_get_ps_detect_image(
#     imgPost: ImgPost,
#     strictness_int: StrictnessIntEnum = Query(
#         StrictnessIntEnum.MEDIUM,
#         description=get_enum_description(StrictnessIntEnum),
...
#         / "img/has_ps_passbook_example.png"
#     )
#     return StreamingResponse(
#         EXAMPLE_IMG_PATH.open("rb"),
